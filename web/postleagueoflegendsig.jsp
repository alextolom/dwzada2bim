...
<head>
    ...
    <title>Campeão mundial de League of Legends 2018 é qualificado para o torneio MSI de 2019</title>
...
-->
    ...
    <div class="nk-main">
        ...
        <div class="nk-header-title nk-header-title-lg">
            <div class="bg-image">
                <div style="background-image: url('images/ig.jpg');"></div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="nk-blog-post nk-blog-post-single">
                        <h1 class="display-4">Campeão mundial de League of Legends 2018 é qualificado para o torneio MSI de 2019</h1>

                        <div class="nk-post-meta">
                            <div class="nk-post-date">28 de abril, 2019</div>
                            <div class="nk-post-category"><a href="#">E-Sports</a></div>
                            <div class="nk-post-comments-count">2 Comentários</div>
                        </div>

                        <!-- START: Post Text -->
                        <div class="nk-post-text">
                            <p>A Invictus Gaming, um time de E-Sports chinês, que venceu o Mundial de League of Legends em 2018, está novamente entrando para aos palcos internacionais após vencer a final regional da China (LPL Spring Split 2019) contra a JDG nesse domingo.<br><br>
                            ...
                            <br><br>The score of the final was one-sided but the third match was very thrilling, in which the two teams secured more than 40 kills in just 30 minutes.</p>
                        ...
                        <div class="nk-post-share">
                            <strong>Caso queira compartilhar o post:</strong>
        ...
        <div class="nk-comments">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h3 class="nk-title">Comentários:</h3>
                        ...
                        <div class="nk-comment">
                            ...
                            <div class="nk-comment-meta">
                                ...
                                <div class="nk-comment-reply"><a href="#">Responder</a></div>
                                <div class="nk-comment-date">29 de abril, 2019</div>
                            </div>
        ...
        <div class="nk-reply">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h3 class="nk-title">Comentar</h3>
                        <div class="nk-gap-1"></div>
                        <form action="#" class="nk-form">
                            <div class="nk-gap-1"></div>
                            <textarea class="form-control required" name="message" rows="8" placeholder="Seu comentário..." aria-required="true"></textarea>
                            <div class="nk-gap-1"></div>
                            <div class="nk-form-response-success"></div>
                            <div class="nk-form-response-error"></div>
                            <button class="nk-btn">Postar comentário</button>
                        </form>
                    </div>
                </div>
            </div>
