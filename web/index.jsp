            ...
            <div class="container">
                <div class="nk-nav-table">
                    ...
                    <ul class="nk-nav nk-nav-right hidden-md-down" data-nav-mobile="#nk-nav-mobile">
                        <li>
                            <a href="index.jsp#about">Quem somos</a>
                        </li>
                        <li>
                            <a href="index.jsp#contact">Suporte</a>
                        </li>
                        <li>
                            <a href="foruns.jsp">Comunidades</a>
                        </li>
                        <li>
...
-->
    ...
    <div class="nk-main">
        ...
        <div class="nk-header-title nk-header-title-full">
            <div class="bg-image">
                <div style="background-image: url('images/wallpaper2.jpg');"></div>
            ...
            <div class="nk-header-table">
                <div class="nk-header-table-cell">
                    <div class="container">
                        ...
                        <h2 class="nk-subtitle text-white">Social media creates communities.</h2>


                        <h1 class="nk-title display-3 text-white">Orange WorldWIDE
                            <br>
                            <em class="fw-400">a mídia social com as melhores ligações para conteúdo na web!</em>
                        </h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 text-xs-center">
                        ...
                        <h2 class="display-4">Our infos</h2>
                        <div class="nk-gap mnt-5"></div>

                        <p>Somos uma nova rede social que provide comunidades para discussões mais organizadas e buscas (tanto para trabalho ou lazer) mais fáceis.</br></br>Inspirados fortemente pela grande plataforma Reddit.
                        </p>
        ...
        <div class="nk-box bg-white" id="projects">
            ...
            <h2 class="text-xs-center display-4">OS MAIS ACESSADOS</h2>

            <div class="nk-gap mnt-6"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="text-xs-center">Conheça e descubra os assuntos do momento.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="nk-portfolio-list nk-isotope nk-isotope-3-cols">
                ...
                <div class="nk-isotope-item" data-filter="Mockup">
                    <div class="nk-portfolio-item nk-portfolio-item-square nk-portfolio-item-info-style-1">
                        <a href="portfolio-single.jsp" class="nk-portfolio-item-link"></a>
                ...
                <div class="nk-carousel nk-carousel-all-visible text-white" data-autoplay="18000" data-dots="true">
                    <div class="nk-carousel-inner">
                        <div>
                            <div>
                                <blockquote class="nk-blockquote-style-1 text-white">
                                    <p>Uma das melhores plataformas que conheci nos últimos tempos, suporte brasileiro e de qualidade!</p>
                                    <cite>Usuário anônimo</cite>
                                </blockquote>
                        ...
                        <div>
                            <div>
                                <blockquote class="nk-blockquote-style-1 text-white">
                                    <p>Utilizo muito no dia a dia para procurar por dicas cotidianas.</p>
                                    <cite>Usuário anônimo</cite>
                                </blockquote>
                                <div class="nk-gap-3 mt-10"></div>
                            </div>
                        ...
                        <div>
                            <div>
                                <blockquote class="nk-blockquote-style-1 text-white">
                                    <p>Me ajuda muito no trabalho. Principalmente na área de programação!!</p>
                                    <cite>Usuário anônimo</cite>
                                </blockquote>
                                <div class="nk-gap-3 mt-10"></div>
                            </div>
        ...
        <div class="container" id="contact">
            ...
            <div class="row vertical-gap">
                <div class="col-lg-5">
                    ...
                    <p>Está com dúvida? Precisa de ajuda? Entre em contato pelo primeiro email listado abaixo, caso não receba retorno em no máximo 2 dias, entre em contato com o email alternativo.</p>

                  	<strong>Our support is currently working only on Brazil. Please be patient for upcoming countries.</strong><br>

                    <ul class="nk-contact-info">
                        <li>
                            <strong>Email:</strong> alextolom2510@gmail.com</li>
                        <li>
                            <strong>Email alternativo:</strong> xandy_tolomeo@hotmail.com</li>
                    </ul>
                    <!-- END: Info -->
                </div>
                <div class="col-lg-7">
                    ...
                    <form action="#" class="nk-form nk-form-ajax">
                        ...
                        <input type="text" class="form-control required" name="title" placeholder="Assunto">

                        <div class="nk-gap-1"></div>
                        <textarea class="form-control required" name="message" rows="8" placeholder="Comentário" aria-required="true"></textarea>
                        <div class="nk-gap-1"></div>
                        <div class="nk-form-response-success"></div>
                        <div class="nk-form-response-error"></div>
                        <button class="nk-btn">Enviar mensagem</button>
                    </form>
                    <!-- END: Form -->
                </div>
            </div>
