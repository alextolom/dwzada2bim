 ...
 * @author a1817744
 */
@WebServlet(name = "ComunidadeServlet", urlPatterns = {"/comunidade"})
...
//            String imagemComunidade = request.getParameter("imagemcomunidade");
...
//            comunidade.setImagemComunidade(imagemComunidade);
            ...
            daoComunidade.inserir(comunidade);
            
            response.sendRedirect(request.getContextPath() + "/foruns.jsp");
